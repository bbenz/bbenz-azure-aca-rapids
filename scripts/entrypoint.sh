...
export SPARK_CLASSPATH=/opt/rapids/rapids-4-spark_2.12-23.12.0.jar:/opt/rapids/rapids-4-spark_2.12-23.12.0-cuda12.jar:/app/xgboost-rapids-aca.jar
export SPARK_SUBMIT_OPTS="--conf spark.driver.extraClassPath=/opt/rapids/rapids-4-spark_2.12-23.12.0.jar:/opt/rapids/rapids-4-spark_2.12-23.12.0-cuda12.jar"
...
if [ "$USE_GPU" = "true" ]; then
  ...
  GPU_ENABLED_CONFIGS="--conf spark.plugins=com.nvidia.spark.SQLPlugin \
                       ...
                       --jars /opt/rapids/rapids-4-spark_2.12-23.12.0.jar,/opt/rapids/rapids-4-spark_2.12-23.12.0-cuda12.jar"
